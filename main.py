...
def fit_linear(filename):
    ...
    #It saves the plot as linear_fit in format SVG and shows it.
    return
...
def search_best_parameter(filename):
    ...
    #save as 'linear_fit.svg' and show.
    val_chi2=[]
    for a in val_a:
    ...
    pyplot.show()
    #plot chi^2 v.s a for b that was found.
    #save as 'numeric_sampling.svg' and show.
    return
...
def check_input(L):
    ...
    #If such case, it prints an error notification and stops the function.
...
#A function calculating chi squared and chi squared reduced.
...
#fit_linear('valid_input_columns.txt')
search_best_parameter('input_bonus.txt')
